...
SDL_WINDOWPOS_CENTERED_DISPLAY( X ) = SDL_WINDOWPOS_CENTERED_MASK | UInt32(X)
SDL_WINDOWPOS_CENTERED() = SDL_WINDOWPOS_CENTERED_DISPLAY( UInt32(0) )
SDL_WINDOWPOS_ISCENTERED( X ) = ( ( ( UInt32(X) ) & 0xFFFF0000 ) == SDL_WINDOWPOS_CENTERED_MASK )
